...
echo -e "${CMNTTEXT}Creating location /usr/lib/firmware/hm2/hostmot2${NOCOLOR}"
cd /usr/lib/firmware/hm2
sudo mkdir hostmot2
#
# Copy the files
echo -e "${CMNTTEXT}Copying the files to /usr/lib/firmware/hm2/hostmot2${NOCOLOR}"
...
#
# Flash the Mesa card
echo -e "${CMNTTEXT}Flashing the Mesa Card Configuration${NOCOLOR}"
...
echo -e "${CMNTTEXT}Unzip the files to /home/cnc/lnuxcnc/configs/Rosetta${NOCOLOR}"
sudo unzip Rosetta.zip -d /home/cnc/lnuxcnc/configs 
#
# Set the security for the subdirectories
echo -e "${CMNTTEXT}All all access to /home/cnc/linuxcnc/configs/Rosetta/Rosetta_Axes${NOCOLOR}"
sudo chmod 777 -R /home/cnc/linuxcnc/configs/Rosetta/Rosetta_Axes
echo -e "${CMNTTEXT}All all access to /home/cnc/linuxcnc/configs/Rosetta/Rosetta_Display${NOCOLOR}"
